...
class Updatebabyinfo extends StatefulWidget {
  final int babyId;
  final BabyModel babyDetails;

  const Updatebabyinfo({
    Key? key,
    required this.babyId,
    required this.babyDetails,
  }) : super(key: key);

  @override
  _UpdatebabyinfoScreenState createState() => _UpdatebabyinfoScreenState();
}

class _UpdatebabyinfoScreenState extends State<Updatebabyinfo> with TickerProviderStateMixin {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Header Section
              Text(
                'Change details for ${widget.babyDetails.babyName}',
                style: TextStyle(
                  fontSize: 24,
                  fontWeight: FontWeight.bold,
                  color: Color(0xFF2E3E5C),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    final result = await babyHelper.updateBaby(newBaby);
                    if (result > 0) {
                      Navigator.pop(context, newBaby);
                      _showSuccessSnackBar('Baby updated successfully');
                    } else {
